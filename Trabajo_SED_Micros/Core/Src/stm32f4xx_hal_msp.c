...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC1     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(Sensor_temperatura_GPIO_Port, Sensor_temperatura_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM10_MspPostInit 0 */
    ...
    PB8     ------> TIM10_CH1
    */
    GPIO_InitStruct.Pin = ENABLE_VENTILADOR_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM10;
    HAL_GPIO_Init(ENABLE_VENTILADOR_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE9     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(ECHO_ULTRASONIDOS_GPIO_Port, ECHO_ULTRASONIDOS_Pin);
